...
/*
 continue with solution 2:
 1. for the 1st comparison of the heads nodes of the k lists, we can sore them out, so we get the
   1.1 the smallest node, and
   1.2 a sorted k-1 nodes

 2. for the next N-1 comparison, use inesrt search logN
